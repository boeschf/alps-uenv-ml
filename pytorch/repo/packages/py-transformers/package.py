...
class PyTransformers(PythonPackage):
    ...
    version("4.40.2", sha256="657b6054a2097671398d976ad46e60836e7e15f9ea9551631a96e33cb9240649")
    ...
    depends_on("py-huggingface-hub@0.19.3:0", when="@4.40:", type=("build", "run"))
    ...
    depends_on("py-safetensors@0.4.1:", when="@4.40:", type=("build", "run"))
    depends_on("py-safetensors@0.3.1:", when="@4.31:", type=("build", "run"))
    depends_on("py-tokenizers@0.19:0.20", when="@4.40:", type=("build", "run"))
    depends_on("py-tokenizers@0.14:0.18", when="@4.35:4.39", type=("build", "run"))
